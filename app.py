...
try:
    ...
    data_loaded = False
    st.error(
        "Couldn't connect to the SQL Server database. Descriptive/Diagnostic tabs need a live "
        "connection to your Ecommerce_Analytics_project database on this machine.\n\n"
        f"Error: {e}"
    )
...
if data_loaded:
    with tab_desc:
        ...
        with d1:
            ...
            st.dataframe(monthly_revenue, width='stretch', hide_index=True)
            ...
            st.dataframe(monthly_revenue[['months', 'price_usd', 'pct_change']], width='stretch', hide_index=True)
    ...
    with tab_diag:
        ...
        with g1:
            ...
            st.dataframe(rev_vs_sessions, width='stretch', hide_index=True)
            conclude([
